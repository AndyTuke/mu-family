...
P "The Depth knob is bipolar with a centre detent at OFF. Turn it up and the tone morphs from amplitude modulation (AM, carrier present) toward ring modulation (RM, carrier suppressed); the sign flips the modulator phase. The mode switch offers:"
Bullet "Mult — the AM-to-RM morph described above"
...
P "Switching a lane's mode keeps the knob value, so you can audition FM/PM/TZFM (or Mult/SSB) as a smooth A/B."
...
Bullet "Cross-modulation: 2-lane X-Mod - phase/index (FM/PM/TZFM) with Sync and Feedback, plus amplitude (AM-to-RM morph and SSB frequency shift)"
