...
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(disable: 4100) // unreferenced formal parameter — intentional in no-op ignore stubs
#endif
...
#pragma warning(pop)
	...
	public:
		...
		bool configure(double sr, size_t maxBlockSize, size_t numChannels=2) {
			return configure(sr, maxBlockSize, numChannels, numChannels);
		}
		bool configure(double sr, size_t maxBlockSize, size_t inputChannels, size_t outputChannels) {
