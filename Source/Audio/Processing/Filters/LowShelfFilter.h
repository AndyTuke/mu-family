...
// #427: type 13 — biquad low shelf, fixed +12 dB gain. Cutoff is the corner
// frequency below which the shelf takes effect.
class LowShelfFilter : public FilterAlgorithmBase
{
public:
                 ...
                 float cutoffHz, float resonance) override
    {
        ...
        if (dirty)
        {
            ...
            for (int ch = 0; ch < 2; ++ch)
                eq[ch].setLowShelf(cutoffHz, q, 12.0f, (float) currentSampleRate);
