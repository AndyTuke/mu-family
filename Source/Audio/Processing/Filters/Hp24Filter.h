...
// #427: type 5 — 24 dB/oct highpass via JUCE's LadderFilter (Moog-style).
class Hp24Filter : public FilterAlgorithmBase
{
public:
    void prepare(double sampleRate, int blockSize, int numChannels) override
    {
        ...
        ladder.setMode(juce::dsp::LadderFilter<float>::Mode::HPF24);
    }
