...
// #427: type 14 — biquad high shelf, fixed +12 dB gain. Cutoff is the corner
// frequency above which the shelf takes effect.
class HighShelfFilter : public FilterAlgorithmBase
{
public:
                 ...
                 float cutoffHz, float resonance) override
    {
        ...
        if (dirty)
        {
            ...
            for (int ch = 0; ch < 2; ++ch)
                eq[ch].setHighShelf(cutoffHz, q, 12.0f, (float) currentSampleRate);
