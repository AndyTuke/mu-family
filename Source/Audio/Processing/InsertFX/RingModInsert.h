...
// #425: driveChar = 9. Ring modulator — multiplies the input by a sinusoidal
// carrier at p.driveTone Hz. Per-channel phase accumulators preserve continuity
// across blocks. Mix knob (p.driveDrive) blends dry → ring-modulated.
