...
struct ReverbSlot::ReverbImpl
{
    ...
    // #358: snapshot of computed reverb parameters. Message thread (updateReverb)
...
void ReverbSlot::processReturn(juce::AudioBuffer<float>& buffer)
{
    ...
    // #358: apply any pending Signalsmith reverb param changes BEFORE process().
...
{
    // #358: compute the snapshot here (message thread) — the audio thread copies it
