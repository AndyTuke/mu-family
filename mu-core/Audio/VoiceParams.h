...
struct VoiceParams
{
    ...
    // output-mix multiply via juce::Decibels::decibelsToGain — keeps the
    // UI/APVTS/voiceParams unit consistent for attachment-friendly wiring.
    float ampLevel    = 0.0f;        // dB, default 0 dB (= unity gain)
