...
message(STATUS "Deploying μ-Clid Lite Release artifacts to: ${DIST_WIN}")

if(IS_DIRECTORY "${VST3_BUNDLE}")
    file(COPY "${VST3_BUNDLE}" DESTINATION "${DIST_WIN}")
    message(STATUS "  VST3 -> ${DIST_WIN}/μ-Clid Lite.vst3")
else()
    message(WARNING "  VST3 bundle not found: ${VST3_BUNDLE}")
endif()

if(EXISTS "${CLAP_FILE}")
    file(COPY_FILE "${CLAP_FILE}" "${DIST_WIN}/μ-Clid Lite.clap" ONLY_IF_DIFFERENT)
    message(STATUS "  CLAP -> ${DIST_WIN}/μ-Clid Lite.clap")
else()
